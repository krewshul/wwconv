...
def result():
    ...
    fww = USDTOBTC / Decimal(fprice)
    unww = USDTOBTC / Decimal(unprice)
    return render_template("result.html", priceoforder=var1, priceofshipping=var2, btcprice=btcprice, fprice=fprice, unprice=unprice, USDTOBTC=USDTOBTC, entry=entry, fww=fww, unww=unww)
